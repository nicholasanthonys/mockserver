...
3. Example of how to start a container : ```docker run -d --rm -p 1080:1080 --env=MOCKSERVER_INITIALIZATION_JSON_PATH=/mock/config.json -v /host-path/mock:/mock imagename:tag```
